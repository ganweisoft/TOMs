...
# 1. 简介
**TOMs** 是一个完全开源、高性能、体系化、插件化、面向各种智慧化场景的通用开发框架。**TOMs**的基于最新的 **.NET 9.0** 构建，其扩展插件可以使用 **C#**、 **Java**、**Python**、**C++**、**Go** 和 **Rust** 等编程语言进行开发。TOMs 支持云原生部署、本地部署（**Windows**、**Linux**、**macOS**）和嵌入式设备部署。
